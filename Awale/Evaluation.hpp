...
int valeurMinMaxModifie(Position *courante, int profondeur, int profondeur_max, bool ordi_joueur1, int bound_a_b, int a1, int a2, int a3, int a4, int a5, int a6, bool ordi_j1);
